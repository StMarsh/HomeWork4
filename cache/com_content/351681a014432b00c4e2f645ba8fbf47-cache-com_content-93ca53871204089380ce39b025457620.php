<?php die("Access Denied"); ?>#x#a:4:{s:4:"body";s:3246:"<div class="item-page">

	<h2>
			<a href="/joomla3/index.php/component/content/article/2-uncategorised/2-2-art">
		2-art</a>
		</h2>
	...
	<ul class="actions">
			...
			<a href="/joomla3/index.php/component/content/article/2-uncategorised/2-2-art?tmpl=component&amp;print=1&amp;page=" title="Print" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow"><img src="/joomla3/media/system/images/printButton.png" alt="Print"  /></a>			</li>
					...
					<li class="email-icon">
			<a href="/joomla3/index.php/component/mailto/?tmpl=component&amp;template=beez_20&amp;link=dce63ee9603ccc1dbfac51d835f68fc90aa4ac27" title="Email" onclick="window.open(this.href,'win2','width=400,height=350,menubar=yes,resizable=yes'); return false;"><img src="/joomla3/media/system/images/emailButton.png" alt="Email"  /></a>			</li>
	...
	<dd class="published">
	Published on Saturday, 09 November 2013 15:54	</dd>
	<dd class="createdby">
...
<p>Sed porta, nisi in lacinia scelerisque, turpis leo commodo arcu, nec volutpat mi erat in leo. Sed rutrum mauris at malesuada hendrerit. Maecenas justo velit, ultricies sed ante eget, porta ultrices massa. In a varius orci, ut ullamcorper sapien. Fusce pharetra tellus sed sapien pulvinar rhoncus. Duis nec ligula felis. Etiam at lacus ac justo tincidunt convallis sit amet ac diam. Vestibulum consectetur vehicula vulputate. Praesent nec felis vel lectus aliquet accumsan id eget justo. Suspendisse placerat sollicitudin lacus, quis pellentesque arcu aliquet ac.</p>
				...
				<ul class="pagenav">
					<li class="pagenav-next">
						<a href="/joomla3/index.php/component/content/article/2-uncategorised/1-1-art" rel="next">Next &gt;</a>
					</li>
				</ul>
